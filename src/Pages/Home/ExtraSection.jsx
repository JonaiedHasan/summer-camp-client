...
const ExtraSection = () => {
    return (
        ...
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-color text-center">Fitness Tips for Beginners</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className=" p-6 rounded-lg shadow-lg bg-blue-50">
              <h3 className="text-xl font-bold mb-2 text-color">Start Slow and Gradually Increase Intensity</h3>
            ...
            <div className=" p-6 rounded-lg shadow-lg bg-blue-50">
              <h3 className="text-xl font-bold mb-2 text-color">Focus on Form and Technique</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="shadow-lg bg-blue-50 p-6 rounded-lg ">
              <h3 className="text-xl text-color font-bold mb-2">Listen to Your Body</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="shadow-lg bg-blue-50 p-6 rounded-lg ">
              <h3 className="text-xl text-color font-bold mb-2">Stay Consistent</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="shadow-lg bg-blue-50 p-6 rounded-lg ">
              <h3 className="text-xl text-color font-bold mb-2">Mix Up Your Workouts</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className=" p-6 rounded-lg shadow-lg bg-blue-50">
              <h3 className="text-xl text-color font-bold mb-2">Stay Hydrated and Eat Well</h3>
              <p className="text-gray-600 mb-4">
